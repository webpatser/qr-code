...
class AdditionalTests extends TestCase
{
    ...
    public function testQRCodeErrorCorrectionLevels()
    {
        $levels = ['L', 'M', 'Q', 'H'];
    ...
    public function testQRCodeSizes()
    {
        $sizes = [1, 3, 5, 10];
    ...
    public function testQRCodeMargins()
    {
        $margins = [0, 2, 4, 8];
    ...
    public function testQRCodeColors()
    {
        $colors = [
    ...
    public function testLongTextHandling()
    {
