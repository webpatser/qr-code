...
class QRCodeIntegrationTest extends TestCase
{
    ...
    public function testCompleteQRCodeWorkflow()
    {
        $testData = [
    ...
    public function testQRCodeTypeClasses()
    {
        $types = [
    ...
    public function testDifferentOutputFormats()
    {
    ...
    public function testVCardGeneration()
    {
    ...
    public function testCalendarEventGeneration()
    {
